...
- Name: editor.spec.ts >> Page Studio Editor >> should add text component and edit content
- Location: tests/e2e/editor.spec.ts:159:7
...
Call log:
  - waiting for getByRole('button', { name: /text/i }).first()
