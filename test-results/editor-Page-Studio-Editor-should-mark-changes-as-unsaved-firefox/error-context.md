...
- Name: editor.spec.ts >> Page Studio Editor >> should mark changes as unsaved
- Location: tests/e2e/editor.spec.ts:178:7
...
Locator: locator('text=Unsaved changes')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Unsaved changes')
