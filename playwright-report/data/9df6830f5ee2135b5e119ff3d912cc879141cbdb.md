...
- Name: preview.spec.ts >> Preview Pages >> Preview Navigation >> should navigate back to home
- Location: tests/e2e/preview.spec.ts:42:9
...
Call log:
  - waiting for getByRole('button', { name: /back|home/i }).first()
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    - generic [ref=e4]:
      - generic [ref=e5]:
        - link "Back to editor" [ref=e6] [cursor=pointer]:
          - /url: /editor
          - img [ref=e7]
        - generic [ref=e10]:
          - heading "Demo Page" [level=1] [ref=e11]
          - paragraph [ref=e12]: Draft Preview
      - generic [ref=e13]:
        - generic [ref=e14]: Draft
    ...
    - main [ref=e17]:
      - generic [ref=e19]:
        - paragraph [ref=e20]: fdsfs
        - button "dsf" [ref=e22] [cursor=pointer]
    - contentinfo [ref=e23]:
      - paragraph [ref=e25]: Draft version - changes are not yet published
