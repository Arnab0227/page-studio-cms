...
- Name: editor.spec.ts >> Page Studio Editor >> should display component count in status bar
- Location: tests/e2e/editor.spec.ts:267:7
...
Locator: locator('text=1 component on page')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=1 component on page')
