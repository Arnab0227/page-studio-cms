...
- Name: editor.spec.ts >> Page Studio Editor >> should add hero component
- Location: tests/e2e/editor.spec.ts:233:7
...
Locator: locator('text=Welcome to our page')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Welcome to our page')
